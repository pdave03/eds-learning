...
const ICONS = {
  ...
  twitter: '<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M18.24 2.25h3.31l-7.23 8.26 8.5 11.24h-6.66l-5.21-6.82-5.97 6.82H1.66l7.73-8.84L1.23 2.25H8.1l4.71 6.23 5.43-6.23Zm-1.16 17.52h1.83L7.01 4.13H5.05l12.03 15.64Z"/></svg>',
...
const NETWORKS = [
  ...
  { key: 'twitter', match: ['twitter', 'x.com'], label: 'X (Twitter)' },
