...
const PAGE_TEMPLATE = {
  name: 'about-us',
  description: 'WKND About Us page: About Us title, and two contributor sections (Our Contributors, WKND Guides) each with an intro paragraph and a grid of contributor cards.',
  urls: [
  ...
  blocks: [
    {
      name: 'contributors',
      instances: ['div.cmp-container:has(> div.image):has(> div.title)'],
    },
  ],
  sections: [
    {
